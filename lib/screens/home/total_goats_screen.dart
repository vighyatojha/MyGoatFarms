...
class _TotalGoatsScreenState extends State<TotalGoatsScreen> {
  ...
  // calling allActiveGoatsStream(...) directly inside build() hands
  // StreamBuilder a brand-new stream every rebuild, forcing it to drop its
  // subscription and flash back to the loading state.
